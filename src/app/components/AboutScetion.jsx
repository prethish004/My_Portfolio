    ...
    <section className="text-white scroll-mt-20" id="about">
      <div className="md:grid md:grid-cols-2 gap-10 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          <h2 className="text-4xl font-bold text-white mb-4">About Me</h2>
          <p className="text-base lg:text-lg">
            I am a motivated Machine Learning Engineer with a solid foundation
            in AI and data science. I am skilled in developing and deploying
            models to address complex challenges and drive data-driven
            decisions.
          </p>
          <p className="text-base lg:text-lg mt-4">
            With experience working on diverse datasets, conducting exploratory
            data analysis, and crafting actionable insights, I bring a
            data-centric approach to problem-solving. My technical expertise
            includes programming in Python and working with frameworks like
          ...
          <div className="mt-8">
            ...
            {/* Skills Details */}
            <div className="space-y-4">
              {content[activeCategory].map((skill, index) => (
